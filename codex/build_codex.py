...
- utterances         sliced from exact Tome of Magic detail spans; complete
                    normal/reverse descriptions bypass the 4.2k cap.
...
def selftest():
    ...
    specs = _family_specs()
    assert len(specs) == 42
    assert sum(spec["expected_count"] for spec in specs) == 18_159
    ...
    print("selftest: 42-family registry totals 18,159 rows")
    print("selftest: PASS")
