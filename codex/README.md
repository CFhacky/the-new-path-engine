...
- **Every slice** is validated: the entry name—or the canonical common
  `description_key` for an epic-item variant—must lead it, or the block is
...
the army book) and the remaining epic monster/spell families, whose harvesters
recorded only a marker offset. That is honest emptiness, not a bug.

## Coverage (as of this build)

**11,777 of 17,951 entries** carry the full verbatim block. Strong: D&D 3.5e
creatures 99% / spells, epic items, maneuvers, soulmelds, and vestiges 100% /
epic feats 97% / feats 86%, GURPS 3e & 4e creatures and spells 94–100%, AD&D
100%, WFRP creatures 100%, 40K RP adversaries/talents/psychic ~99–100%. Known
low families (need harvester-level work to lift): GURPS gear/skill/trait/
technique, epic monsters/spells, and the 40K RP weapon/gear tables (which already
display their mechanical fields).
