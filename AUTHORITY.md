...
| `spell_harvest.py` | bundled SRD 3.5 spells + cited Spell Compendium extraction; school-anchored detection (sibling of power_harvest.py, no import); missing sources print NO COVERAGE |
