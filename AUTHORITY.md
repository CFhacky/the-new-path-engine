...
| `gurps_creature_harvest.py` | cited GURPS bestiary extractions (Dungeon Fantasy Monsters, Creatures of the Night); attribute-block detection, two stat formats; a separate index from D&D creatures; missing sources print NO COVERAGE |
