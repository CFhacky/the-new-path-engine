...
| `notion_novel_bind.py` | corpus tooling: strips the Notion fetch wrapper from a long-form page dump and binds EPUB 3 with the standard library; the text passes through untouched; outputs live in the sourcebook corpus, not here |
