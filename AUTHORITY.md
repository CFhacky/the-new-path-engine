...
| `prestige_class_harvest.py` | D&D 3.x prestige classes VISION-TRANSCRIBED from the Dragon Magazine Prestige Class Compendium PDF images (321 of 355 pages are image-only); all 145 retain canonical name + hit die + full requirements + page, while 16 recovered rows carry validated exact spans into four batch-derived Markdown sources and separate PDF provenance; still book RAW |
