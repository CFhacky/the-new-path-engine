...
| `ad2e_monster_index.{json,md}` | **AD&D 2e** monsters (full stat block: AC/HD/THAC0/No.App/align/size/XP) — labeled `system: AD&D 2e`, vision-transcribed | 25 | `scripts/ad2e_monster_harvest.py` | Planescape MC Appendix II (2e) — PDF page images |
