...
|---|---|---|---|---|
| `creature_index.{json,md}` | monster/NPC stat-block index | 1602 | `scripts/creature_harvest.py` | the `_md\_bestiary` twelve (MM1–5, Draconomicon, ELH, FC1/2, Fiend Folio, Libris Mortis, Lords of Madness) + Book of Vile Darkness, Deities and Demigods, Monsters of the Planes |
