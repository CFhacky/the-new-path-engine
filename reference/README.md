...
| `ad2e_spell_index.{json,md}` | **AD&D 2e** spells (school/sphere, level, wizard/priest, range, duration, casting time, area, save) — labeled `system: AD&D 2e` | 62 | `scripts/ad2e_spells_harvest.py` | Menzoberranzan + FOR2/FOR5/FOR7 (2e) — born-digital text |
