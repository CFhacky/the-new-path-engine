...
| `gurps_creature_index.{json,md}` | GURPS bestiary (ST/DX/IQ/HT/HP/…) | 52 | `scripts/gurps_creature_harvest.py` | GURPS Dungeon Fantasy Monsters 1 + Creatures of the Night + Fantasy — separate from the D&D `creature_index` |
