...
| `gurps_creature_index.{json,md}` | GURPS bestiary (ST/DX/IQ/HT/HP/…) | 326 | `scripts/gurps_creature_harvest.py` | GURPS DF Monsters, Creatures of the Night, Fantasy, Banestorm, Lands Out of Time, DF Allies/Summoners, Big Lizzie — separate from the D&D `creature_index` |
