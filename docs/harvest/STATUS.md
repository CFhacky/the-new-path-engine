...
The verified Codex build contains all 18,163 accepted entries and attaches
13,351 validated full-text blocks (73.5%). Missing full text affects the
...
Expected terminal summaries are `REFERENCE_AUDIT families=42 rows=18163
errors=0`, `LIVE_SELFTESTS total=42 failed=0`, and a Codex build of 18,163
entries with 13,351 full-text blocks.
