...
**At a glance (2026-08-28).** Eighteen reference index families, ~10,000 entries.
...
(1841), GURPS spells (557), GURPS creatures (326), GURPS gear — weapons + armor
